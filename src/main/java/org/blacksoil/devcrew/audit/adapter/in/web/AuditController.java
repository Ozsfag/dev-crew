...
public class AuditController {
  ...
  public PageResult<AuditResponse> getAuditEvents(
    ...
    PageResult<AuditEventModel> result;
    if (actorId != null) {
      result = auditQueryService.findByActorId(actorId, page, size);
    } else if (projectId != null) {
      result = auditQueryService.findByProjectId(projectId, from, to, page, size);
    } else {
      result = auditQueryService.findByTimestampBetween(from, to, page, size);
    }
