...
/**
 * Инструменты для работы с Docker из агента DevOps. Все пути проверяются через SandboxPolicy.
...
public class DockerTools {
  ...
  @Tool(
      "Build a Docker image from the Dockerfile in the given project directory with the specified tag (e.g. myapp:1.0)")
  ...
  @Tool(
      "Pull latest images and start services defined in docker-compose.yml in the given project directory")
