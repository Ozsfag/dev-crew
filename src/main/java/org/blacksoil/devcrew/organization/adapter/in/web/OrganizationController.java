package org.blacksoil.devcrew.organization.adapter.in.web;
...
import org.blacksoil.devcrew.organization.app.service.OrganizationQueryService;
...
public class OrganizationController {
    ...
    public ProjectResponse createProject(
        ...
        return mapper.toResponse(commandService.createProject(orgId, request.name(), request.repoPath()));
    }
    ...
    public List<ProjectResponse> getProjects(
        ...
        return queryService.getProjectsByOrg(targetOrgId).stream()
